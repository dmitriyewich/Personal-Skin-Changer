...
changelog = [[
	...
	- Добавлены три дополнительные функции:
		Проигрывание анимаций(и в предпросмотр тоже)(при случайном наведении может не закрыться, попробую исправить)
...
-- Copyright (c) 2022, dmitriyewich <https://github.com/dmitriyewich/Personal-Skin-Changer>
